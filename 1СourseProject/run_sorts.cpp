...
void run_sorts(vector<vector<double>>& array) {
    ...
    vector<vector<double>> array_for_bubble_sort = array;
    vector<vector<double>> array_for_selection_sort = array;
    vector<vector<double>> array_for_insertion_sort = array;
    vector<vector<double>> array_for_shell_sort = array;
    vector<vector<double>> array_for_quick_sort = array;

    show_matrix(array, array.size(), "Original matrix:");
